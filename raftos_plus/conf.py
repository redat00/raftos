# First Party
from raftos_plus.cryptors import default_cryptor
from raftos_plus.serializers import MessagePackSerializer
...
class Configuration:
    ...
    def default_settings():
        return {
            ...
            # Leader will step down if it doesn't have a majority of follower's
            # responses for this amount heartbeats
